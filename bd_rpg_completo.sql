...
VALUES
    ...
    ('Clérigo', 'Um clérigo começa with 16 pontos de vida (+ modificador de Constituição) e ganha 4 PV (+ mod. Con) por nível.', '5 PM por nível.', 'Religião (Sab) e Vontade (Sab), mais 2 a sua escolha entre Conhecimento (Int), Cura (Sab), Diplomacia (Car), Fortitude (Con), Iniciativa (Des), Intuição (Sab), Luta (For), Misticismo (Int), Nobreza (Int), Ofício (Int) and Percepção (Sab).', 'Armaduras pesadas e escudos', 'Devoto - Clérigo', 'Autoridade Eclesiástica'),
...
INSERT INTO Personagem (nomePersonagem, nivelPersonagem, atrFor, atrDes, atrCons, atrInt, atrSab, atrCar, nomeRaca, nomeOrigem, NomeClasse)
VALUES
('Eldran', 8, 14, 10, 12, 16, 8, 14, 'Elfo', 'Amigo dos Animais', 'Bardo'),
('Thorn', 6, 18, 12, 14, 10, 8, 12, 'Anão', 'Assistente de Laboratório', 'Guerreiro'),
('Luna', 5, 10, 16, 14, 14, 12, 10, 'Elfo', 'Amnésico', 'Druida'),
('Grimm', 9, 20, 14, 16, 12, 10, 8, 'Minotauro', 'Aristocrata', 'Paladino'),
('Seraphina', 4, 8, 16, 12, 18, 14, 12, 'Dahllan', 'Marujo', 'Clérigo'),
('Aeris', 7, 16, 14, 10, 12, 16, 10, 'Elfo', 'Criminoso', 'Ladino'),
('Doran', 10, 18, 12, 16, 8, 10, 12, 'Humano', 'Herói Camponês', 'Barbaro'),
('Lyria', 3, 14, 14, 10, 14, 16, 12, 'Elfo', 'Estudioso', 'Arcanista'),
('Kaldor', 11, 20, 14, 12, 10, 12, 8, 'Goblin', 'Fazendeiro', 'Caçador'),
('Evelyn', 8, 16, 12, 14, 14, 14, 10, 'Lefou', 'Guarda', 'Cavaleiro'),
('Thalia', 6, 12, 16, 14, 12, 10, 18, 'Elfo', 'Eremita', 'Bardo'),
('Branor', 5, 12, 18, 16, 8, 12, 12, 'Minotauro', 'Charlatão', 'Lutador'),
('Fenrir', 4, 14, 10, 14, 12, 14, 16, 'Qareen', 'Herói Camponês', 'Druida'),
('Sylas', 9, 18, 12, 14, 10, 12, 16, 'Goblin', 'Herói Camponês', 'Lutador'),
('Isolde', 7, 16, 14, 14, 10, 14, 12, 'Elfo', 'Estudioso', 'Clérigo'),
('Kara', 10, 20, 12, 14, 14, 8, 14, 'Anão', 'Marujo', 'Barbaro'),
('Naria', 11, 16, 12, 16, 12, 14, 8, 'Elfo', 'Eremita', 'Ladino'),
('Caelum', 8, 14, 14, 12, 16, 12, 10, 'Lefou', 'Eremita', 'Arcanista'),
('Gorrim', 6, 16, 10, 14, 14, 12, 12, 'Goblin', 'Herói Camponês', 'Arcanista'),
('Elira', 5, 14, 12, 12, 14, 18, 10, 'Dahllan', 'Circense', 'Bucaneiro'),
('Dralen', 4, 10, 16, 14, 12, 14, 16, 'Anão', 'Herói Camponês', 'Paladino'),
('Thessa', 9, 18, 12, 14, 10, 12, 16, 'Goblin', 'Guarda', 'Cavaleiro'),
('Aeryn', 7, 16, 14, 10, 14, 12, 14, 'Elfo', 'Artesão', 'Guerreiro'),
('orik', 10, 20, 14, 12, 10, 14, 12, 'Minotauro', 'Marujo', 'Barbaro'),
('Soraya', 11, 16, 12, 16, 14, 10, 12, 'Elfo', 'Charlatão', 'Bardo'),
('Kythos', 8, 16, 14, 10, 14, 14, 12, 'Dahllan', 'Eremita', 'Druida'),
('Nyx', 6, 12, 14, 12, 18, 12, 10, 'Elfo', 'Fazendeiro', 'Lutador'),
('Varis', 5, 14, 16, 10, 12, 18, 12, 'Goblin', 'Herói Camponês', 'Inventor'),
('Aria', 4, 14, 12, 14, 12, 16, 10, 'Elfo', 'Circense', 'Clérigo'),
('Vaelin', 9, 18, 14, 10, 16, 12, 12, 'Minotauro', 'Marujo', 'Paladino'),
('Elysia', 7, 16, 14, 12, 12, 14, 12, 'Lefou', 'Estudioso', 'Arcanista');
...
SELECT * FROM Personagem WHERE nomeClasse = 'Guerreiro' ORDER BY nomePersonagem;
